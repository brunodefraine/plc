...
ext_goal:
	[
		...
		| (x,t,l) = ident_args; "=:="; y = expr -> Relation (EQ, Term (term_lid (x,t,l)),y,_loc)
		| x = other_term; "=:="; y = expr -> Relation (EQ, Term x,y,_loc)
		| "("; x = expr; ")"; "=:="; y = expr -> Relation (EQ, x,y,_loc)
		| (x,t,l) = ident_args; "=\\="; y = expr -> Relation (NE, Term (term_lid (x,t,l)),y,_loc)
		| x = other_term; "=\\="; y = expr -> Relation (NE, Term x,y,_loc)
		| "("; x = expr; ")"; "=\\="; y = expr -> Relation (NE, x,y,_loc) 
		| (x,t,l) = ident_args; "<"; y = expr -> Relation (LT, Term (term_lid (x,t,l)),y,_loc)
		| x = other_term; "<"; y = expr -> Relation (LT, Term x,y,_loc)
		| "("; x = expr; ")"; "<"; y = expr -> Relation (LT, x,y,_loc) 
		| (x,t,l) = ident_args; ">"; y = expr -> Relation (GT, Term (term_lid (x,t,l)),y,_loc)
		| x = other_term; ">"; y = expr -> Relation (GT, Term x,y,_loc)
		| "("; x = expr; ")"; ">"; y = expr -> Relation (GT, x,y,_loc) 
		| (x,t,l) = ident_args; "=<"; y = expr -> Relation (LTE, Term (term_lid (x,t,l)),y,_loc)
		| x = other_term; "=<"; y = expr -> Relation (LTE, Term x,y,_loc)
		| "("; x = expr; ")"; "=<"; y = expr -> Relation (LTE, x,y,_loc) 
		| (x,t,l) = ident_args; ">="; y = expr -> Relation (GTE, Term (term_lid (x,t,l)),y,_loc)
		| x = other_term; ">="; y = expr -> Relation (GTE, Term x,y,_loc)
		| "("; x = expr; ")"; ">="; y = expr -> Relation (GTE, x,y,_loc) 
